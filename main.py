...
# Let me create the enhanced code with smart alerts
...
# =====================
ALERT_CONFIG = {
    # نسبة التغير اللي هتطلع تنبيه (مثلاً 1% = 0.01)
    "pct_threshold": float(os.getenv("ALERT_PCT_THRESHOLD", "0.5")),  # 0.5% default
